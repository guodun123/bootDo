...
public class GenUtils {
    ...
    public static String getFileName(String template, String classname, String className, String packageName) {
        ...
        if (template.contains("model.java.vm")) {
            return packagePath + File.separator + className + "model" + File.separator + className + "DO.java" ;
        }
...
//		}
        ...
        if (template.contains("add.html.vm")) {
            return "main" + File.separator + "resources" + File.separator + "templates" + File.separator
                    + classname + File.separator + classname + "_add.html" ;
        }
        if (template.contains("edit.html.vm")) {
            return "main" + File.separator + "resources" + File.separator + "templates" + File.separator
                    + classname + File.separator + classname + "_edit.html" ;
        }
        ...
        if (template.contains("add.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js" + File.separator
                    + "appjs" + File.separator + classname + File.separator + classname + "_add.js" ;
        }
        if (template.contains("edit.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js" + File.separator
                    + "appjs" + File.separator + classname + File.separator + classname + "_edit.js" ;
        }
